...
solver_cost_type_and_expected = [
    (cls, cost_name, cost, expected) for cls in solver_classes for (cost_name, cost), expected in zip(cost_name_and_type, cost_expected)
]
solver_sens_type_and_expected = [
    (cls, cost_name, cost, expected) for cls in solver_classes for (cost_name, cost), expected in zip(cost_name_and_type, sens_expected)
]
...
@pytest.mark.parametrize("solver_class, cost_name, cost_type, expected", solver_cost_type_and_expected)
